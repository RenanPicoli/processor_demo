...
create_generated_clock -name {sdram_clk_in} -source [get_pins {clk_12MHz|altpll_component|auto_generated|pll1|inclk[0]}] -multiply_by 8 -divide_by 3 -phase -150 -master_clock {clk_in} [get_pins {clk_12MHz|altpll_component|auto_generated|pll1|clk[2]}] 
...
# sdram_ctrl_clk: 133.3MHz
create_generated_clock -name {sdram_ctrl_clk} -source [get_pins {clk_dbg_uproc|altpll_component|auto_generated|pll1|inclk[0]}] -multiply_by 8 -divide_by 3 -phase 0 -master_clock {clk_in} [get_pins {clk_dbg_uproc|altpll_component|auto_generated|pll1|clk[3]}] 
# clk_dbg: 200MHz
