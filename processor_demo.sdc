...
create_generated_clock -name {clk_fs_dbg} -source [get_pins {clk_fs_1536fs|altpll_component|auto_generated|pll1|inclk[0]}] -multiply_by 220 -divide_by 23937 -master_clock {clk_12M} [get_pins { clk_fs_1536fs|altpll_component|auto_generated|pll1|clk[2] }] 
